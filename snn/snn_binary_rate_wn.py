...
wn_save_dir = 'wn_processed_spike_data'
...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        # Iterate over time dimension and update spiking layers each step
        ...
        return torch.stack(spk4_rec, dim=0)  # output shape: (T, B, num_classes)
...
# Load spike data from the white-noise (augmented) dataset
...
if __name__== "__main__":
    ...
    # Build spike tensors and labels for each sample in the white-noise training set
    ...
    # Build spike tensors and labels for each sample in the white-noise test set
    ...
    # Loop through one batch to verify data and label shapes
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        # Training loop over all batches in the training set
        ...
        with torch.no_grad():
            ...
            # Evaluation loop over all batches in the test set
    ...
    torch.save(net.state_dict(), "wn_snn.pth")
