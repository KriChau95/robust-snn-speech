...
# Load the SNN trained with pitch-augmented data and set it to eval mode
net = Net() 
...
with torch.no_grad():
    ...
    # Loop over all pitched samples and compute overall accuracy
    ...
    print("Accuracy on pitch noise data: {:.2f}%".format(test_acc * 100))
