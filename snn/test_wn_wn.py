from snn_binary_rate import Net
import torch
from torch.utils.data import DataLoader
import os
import numpy as np

# Load the SNN trained on white-noise-augmented data and set to eval mode
net = Net() 
net.load_state_dict(torch.load("wn_snn.pth"))
net.eval()
...
# Helper function to load spike data arrays from disk
...
# Build spike tensors and labels for each white-noise training sample
...
# Build spike tensors and labels for each white-noise test sample
...
with torch.no_grad():
    ...
    # Iterate over all white-noise samples and compute classification accuracy
